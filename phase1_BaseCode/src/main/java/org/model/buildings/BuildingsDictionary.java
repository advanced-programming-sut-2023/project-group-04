...
public enum BuildingsDictionary {
    ...
    HEAD_QUARTER("headquarter", BuildingType.CASTLE, 3000, new HashMap<>() {
    }, 1, 0, 0),
    SMALL_STONE_GATEHOUSE("small stone gatehouse", BuildingType.CASTLE, 2600, new HashMap<>() {
    }, 1, 0, 0),
    LARGE_STONE_GATEHOUSE("large stone gatehouse", BuildingType.CASTLE, 3000, new HashMap<>() {
        {
            put("stone", 20);
        }
    }, 1, 0, 0),
    DRAW_BRIDGE("draw bridge", BuildingType.CASTLE, 3000, new HashMap<>() {
        {
            put("wood", 10);
        }
    }, 1, 1, 0),
    ...
    DEFENCE_TURRET("defence turret", BuildingType.CASTLE, 2800, new HashMap<>() {
        {
            put("stone", 15);
        }
    }, 1, 0, 0),
    SQUARE_TOWER("square tower", BuildingType.CASTLE, 3000, new HashMap<>() {
        {
            put("stone", 35);
        }
    }, 1, 0, 0),
    ROUND_TOWER("round tower", BuildingType.CASTLE, 3200, new HashMap<>() {
        {
            put("stone", 40);
        }
    }, 1, 0, 0),
    ARMOURY("armoury", BuildingType.CASTLE, 1600, new HashMap<>() {
        {
            put("wood", 5);
        }
    }, 1, 0, 0),
    BARRACKS("barracks", BuildingType.CASTLE, 2000, new HashMap<>() {
        {
            put("stone", 15);
        }
    }, 1, 0, 0),
    MERCENARY_POST("mercenary post", BuildingType.CASTLE, 2000, new HashMap<>() {
        {
            put("wood", 15);
        }
    }, 1, 0, 0),
    ENGINEER_GUILD("engineer guild", BuildingType.CASTLE, 2000, new HashMap<>() {
        {
            put("wood", 10);
            put("gold", 100);
        }
    ...
    OIL_SMELTER("oil smelter", BuildingType.CASTLE, 2200, new HashMap<>() {
        {
            put("iron", 10);
            put("gold", 100);
        }
    ...
    CAGED_WAR_DOGS("caged war dogs", BuildingType.CASTLE, 1600, new HashMap<>() {
        {
            put("wood", 10);
            put("gold", 100);
        }
    }, 1, 0, 0),
    SIEGE_TENT("siege tent", BuildingType.CASTLE, 1200, new HashMap<>() {
    }, 1, 1, 0),
    STABLE("stable", BuildingType.CASTLE, 1600, new HashMap<>() {
        {
            put("wood", 20);
            put("gold", 400);
        }
