...
public enum SoldiersDictionary {
    ...
    CROSSBOWMAN("crossbow man", 20, "crossBow", "leather", 270, 125, 100, 8, 3),
    SPEARMAN("spearman", 8, "spear", "", 220, 150, 60, 12, 0),
    PIKEMAN("pike man", 20, "pike", "metal", 290, 150, 120, 8, 0),
    MACEMAN("mace man", 20, "mace", "leather", 300, 175, 100, 12, 0),
    ...
    ARABIANBOWS("arabian bow", 75, "bow", "", 270, 125, 80, 16, 5),
    ...
    HORSE_ARCHER("horse archer", 80, "bow", "horse", 340, 125, 100, 20, 6),
    ARABIAN_SWORDSMAN("arabian swordsman", 80, "scimitar", "metalArmour", 360, 175, 120, 20, 0),
    FIRE_THROWER("fire thrower", 100, "greekFire", "", 400, 175, 80, 20, 8);
