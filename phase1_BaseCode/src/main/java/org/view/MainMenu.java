    ...
    public void run() {
        ...
        while (true) {
            ...
            if (MainMenuCommands.getMatcher(input, MainMenuCommands.LOGOUT) != null) {
                ...
                new ProfileMenu().run();
            } else if ((MainMenuCommands.getMatcher(input, MainMenuCommands.ENTER_SHOP_MENU)) != null) {
                System.out.println("you successfully entered \"shop menu!\"");
                new ShopMenu().run();
            } else if ((MainMenuCommands.getMatcher(input, MainMenuCommands.START_GAME)) != null) {
                System.out.println("the game has started!");
                new GameMenu().run();
            } else if ((matcher = MainMenuCommands.getMatcher(input, MainMenuCommands.SHOW_MAP)) != null) {
