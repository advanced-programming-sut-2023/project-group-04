...
public enum SoldiersDictionary {
    ...
    CROSSBOWMAN("crossbowman", 20,"crossBow","leather",0, 0, 0, 8,3),
    SPEARMAN("spearman", 8,"spear","",0, 0, 0, 12,0),
    PIKEMAN("pikeman", 20,"pike","metal",0, 0, 0, 8,0),
    MACEMAN("maceman", 20,"mace","leather",0, 0, 0, 12,0),
    SWORDSMAN("swordsman", 40,"sword","metal",0, 0, 0, 4,0),
    KNIGHT("knight", 40,"sword","metal&horse",0, 0, 0, 20,0),
    ...
    HORSE_ARCHER("horse_archer", 80,"bow","horse",0, 0, 0, 20,6),
    ARABIAN_SWORDSMAN("arabian_swordsman", 80,"scimitar","metalArmour",0, 0, 0, 20,0),
