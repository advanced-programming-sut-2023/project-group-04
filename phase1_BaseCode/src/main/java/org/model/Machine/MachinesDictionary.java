...
public enum MachinesDictionary {
    PORTABLE_SHIELDS("portable_shields", 9, 0, 1000, 0, 1, 5),
    BATTERING_RAMS("battering_rams", 6, 400, 1500, 1, 4, 150),
    SIEGE_TOWER("siege_tower", 6, 0, 1500, 1, 4, 150),
    CATAPULTS("catapults", 7, 200, 950, 30, 2, 150),
